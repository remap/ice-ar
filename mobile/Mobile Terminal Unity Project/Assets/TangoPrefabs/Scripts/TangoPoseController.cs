...
public class TangoPoseController : MonoBehaviour
{
    ...
    private void _UpdatePose()
    {
        ...
        finalPosition = unityWorldOffset_T_unityCamera.GetColumn(3);
        finalRotation = Quaternion.LookRotation(unityWorldOffset_T_unityCamera.GetColumn(2), unityWorldOffset_T_unityCamera.GetColumn(1));
