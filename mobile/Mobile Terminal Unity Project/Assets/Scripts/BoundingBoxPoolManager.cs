...
//		//spawnText.color = color;
	...
	public void UpdateBoundingBoxObject(BoundingBox boundingBox, Vector3 position, float x, float y, float z, string label, Vector3 endPosition)
	{
		try{
...
//		boundingBox.speed = speed;
		boundingBox.target = endPosition;
