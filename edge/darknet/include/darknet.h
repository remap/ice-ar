...
void draw_detections_ndnrtc(image im, int num, float thresh, box *boxes, float **probs, float **masks, char **names, image **alphabet, 
    int classes, NanoPipeFrameInfo finfo, const char*, const char*);
